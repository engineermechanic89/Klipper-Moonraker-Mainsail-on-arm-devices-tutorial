...
6. Log in as user: __root__ pass: __1234__
7. You will be asked to change root passwod so type in Your password twice.
8. Next You will be asked to create ner user, to avoid problems later, name it __pi__ and continue to set up passwod, locale etc.
9. 
